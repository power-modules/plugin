...
- [Config‑Driven Pipelines](config-driven-pipelines.md) — Select steps via configuration.
- [Plugin Catalog & Picker](plugin-picker-ui.md) — Metadata-driven selection without instantiating plugins.
